...
switch ($pas->sm) {																	// reken routine
		...
		case 'ds1': 						
			...
			$pas->tn2	= ' druppels afronden op hele druppels'; 
			$pas->rs	= round( $r6/ $r5 );
		break;	
		case 'ds2': 						
			$pas->tn	= 'in een spuitpomp (50 ml)  met geneesmiddel dat op stand '.$pas->r1.' (ml/uur) wordt afgegeven. Na hoeveel uur is de pomp leeg';
			$pas->tn2	= ' uur naarml afronden '; 
			$pas->rs	= round( 50 / $pas->r1 );
		break;	
		case 'zs1': 						
			$pas->tn	= 'de drukmeter van een 10 l tank geeft '.$pas->r1.' bar aan. Er wordt  '.$pas->r2.' liter per minuut gebruikt. Hoeveel uur kun je met de tank doen';
			$pas->tn2	= ' uur (afronden)'; 
			$pas->rs	= round( ( $pas->r1 * 10) / $pas->r2 );
		break;	
		case 'zs2': 						
			$pas->tn	= 'in een spuitpomp (50 ml)  met geneesmiddel dat op stand '.$pas->r1.' (ml/uur) wordt afgegeven. Na hoeveel uur is de pomp leeg';
			$pas->tn2	= ' ml afronden '; 
